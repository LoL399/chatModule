...
const getAttendantList = data => api.post(`${api.url.room}/attendantsList`,data);
const attend = data => api.put(`${api.url.room}/attend`,data);
const GTFO = data => api.put(`${api.url.room}/GTFO`,data)
...
export default { list, add, hidden, attend, getAttendantList,GTFO};